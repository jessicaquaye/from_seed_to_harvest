...
#SBATCH -o sexual_sdxl-turbo_%j.out     # Standard output and error log
#SBATCH -e sexual_sdxl-turbo_%j.err      # Separate error file
...
INPUT_FNAME="image_ready_sexual_prompts.json"
OUTPUT_DIR="/n/janapa_reddi_lab/Users/jquaye/neurips/sexual_imgs/"
