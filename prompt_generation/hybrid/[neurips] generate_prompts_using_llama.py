...
# file_path = '/n/holylabs/LABS/janapa_reddi_lab/Users/jquaye/neurips/llama_combined_bias.json'
    ...
    # if prompt_id not in prev_gen_prompt_ids:
        ...
        for attack_name, attack_instr in attack_strategies.items():
            ...
            if prompt_id in responses_dict:
                responses_dict[prompt_id].update({attack_name:response_text})
            else:
                responses_dict[prompt_id] = {attack_name:response_text}

        with open('/n/holylabs/LABS/janapa_reddi_lab/Users/jquaye/neurips/llama_responses_' + failure + '_' + str(new_start) + '.json', 'w') as fp:
