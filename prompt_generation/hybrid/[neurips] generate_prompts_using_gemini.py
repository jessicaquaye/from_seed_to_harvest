...
# file_path = '/n/holylabs/LABS/janapa_reddi_lab/Users/jquaye/neurips/gemini_sexual_halfway.json'
...
for prompt_id in prompt_data:
    # if prompt_id not in prev_gen_prompt_ids:
        ...
        with open('/n/holylabs/LABS/janapa_reddi_lab/Users/jquaye/neurips/gemini_responses_' + failure + '_' + str(new_start) + '.json', 'w') as fp:
