...
for prompt_id in violent_pids:
        ...
        with open('/n/holylabs/LABS/janapa_reddi_lab/Users/jquaye/neurips/claude_SO_' + failure + '_' + str(new_start) + '.json', 'w') as fp:
