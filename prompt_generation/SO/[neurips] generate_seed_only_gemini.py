...
for prompt_id in violent_pids:
        ...
        responses_dict[prompt_id] = response

        #checkpointing after generating the 8 versions for one prompt
        with open('/n/holylabs/LABS/janapa_reddi_lab/Users/jquaye/neurips/gemini_SO_' + failure + '_' + str(new_start) + '.json', 'w') as fp:
